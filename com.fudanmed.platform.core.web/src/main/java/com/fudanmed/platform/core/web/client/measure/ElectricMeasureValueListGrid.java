...
public class ElectricMeasureValueListGrid extends GXTGridComponent<UIElectricMeasureValue> implements IInitializerSupport {
  ...
  public DateColumn<UIElectricMeasureValue> measureDate;
  ...
  public void initialize(final IPostInitializeAction handler) {
    ...
    measureDate = dateValueProviderFactory.createAsStringColumn("measureDate","抄表日期",UIElectricMeasureValue.MeasureDateAccessor);
