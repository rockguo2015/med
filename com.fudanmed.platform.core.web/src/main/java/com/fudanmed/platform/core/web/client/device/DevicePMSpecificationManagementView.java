...
public class DevicePMSpecificationManagementView extends GWTAbstractView implements DevicePMSpecificationManagementPresenterView {
  ...
  public void initialize(final IPostInitializeAction postInitialize) {
    com.uniquesoft.gwt.client.common.async.InitializerManager.initialize(
    	com.google.common.collect.Lists.newArrayList(listGrid,categoryListGrid,criteriaForm,batchInitializePMPlanPresenterCommand),
  ...
  public void initialize() {
    ...
    FramedPanel _FramedPanel = this.widgets.FramedPanel("PM\u8BBE\u5907\u4FE1\u606F\u7BA1\u7406");
