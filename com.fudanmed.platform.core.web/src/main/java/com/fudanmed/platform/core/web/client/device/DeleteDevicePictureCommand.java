...
import com.fudanmed.platform.core.web.client.device.DeleteDevicePictureCommandServiceAsync;
...
public class DeleteDevicePictureCommand extends BaseContextAwareSingleObjectCommand<DocumentStorageProxy> implements IContextConsumer<DocumentStorageProxy> {
  @Inject
  protected DeleteDevicePictureCommandServiceAsync _service;
  ...
  public void execute(final DocumentStorageProxy value) {
    ...
    final Procedure1<Void> _function = new Procedure1<Void>() {
        public void apply(final Void it) {
          ...
          AsyncCallback<Void> _onSuccess = DeleteDevicePictureCommand.this.<Void>onSuccess(_function);
