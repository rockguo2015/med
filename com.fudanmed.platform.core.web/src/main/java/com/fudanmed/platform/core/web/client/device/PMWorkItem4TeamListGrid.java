...
public class PMWorkItem4TeamListGrid extends GXTGridComponent<UIPMWorkItem> implements IInitializerSupport {
  ...
  public Iterable<ICanAsWidget> getAllProperties() {
    return com.google.common.collect.Lists.newArrayList(
    					(ICanAsWidget)sid,(ICanAsWidget)assignDate,(ICanAsWidget)dispatchDate,(ICanAsWidget)supplier,(ICanAsWidget)team,(ICanAsWidget)status,(ICanAsWidget)finishDate,(ICanAsWidget)teamComment
    					);
  }
