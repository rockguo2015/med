...
public class ColumnChart<T extends Object> {
  ...
  public ColumnChart(final String xTitle, final String yTitle) {
    this.xTitle = xTitle;
    this.yTitle = yTitle;
  }
  ...
  public Chart<T> asWidget() {
    ...
    final Procedure1<NumericAxis<T>> _function = new Procedure1<NumericAxis<T>>() {
        public void apply(final NumericAxis<T> it) {
          ...
          _fields.add(ColumnChart.this.numberAxisProvider);
          TextSprite _textSprite = new TextSprite(ColumnChart.this.xTitle);
          it.setTitleConfig(_textSprite);
          it.setDisplayGrid(true);
          ColumnChart.this.chart.addAxis(it);
        }
      };
    ...
    final Procedure1<CategoryAxis<T,String>> _function_1 = new Procedure1<CategoryAxis<T,String>>() {
        public void apply(final CategoryAxis<T,String> it) {
          ...
          it.setField(ColumnChart.this.categoryAxisProvider);
          TextSprite _textSprite = new TextSprite(ColumnChart.this.yTitle);
          it.setTitleConfig(_textSprite);
          ColumnChart.this.chart.addAxis(it);
        }
      };
    ...
    final Procedure1<BarSeries<T>> _function_2 = new Procedure1<BarSeries<T>>() {
        public void apply(final BarSeries<T> it) {
          it.setYAxisPosition(Position.LEFT);
          it.addYField(ColumnChart.this.numberAxisProvider);
          ...
          ColumnChart.this.chart.addSeries(it);
        }
      };
