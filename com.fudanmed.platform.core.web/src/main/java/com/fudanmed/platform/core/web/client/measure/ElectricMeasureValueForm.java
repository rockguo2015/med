...
public class ElectricMeasureValueForm extends GXTFormComponent<UIElectricMeasureValue> implements IInitializerSupport {
  @Inject
  ...
  protected ElectricMeasureValueForm doSetValue(final UIElectricMeasureValue value) {
    this.value = value;
  ...
  public Widget asWidget() {
    final Function1<Void,VerticalLayoutContainer> _function = new Function1<Void,VerticalLayoutContainer>() {
        public VerticalLayoutContainer apply(final Void it) {
          VerticalLayoutContainer _VLayout = ElectricMeasureValueForm.this.widgets.VLayout();
          final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
              public void apply(final VerticalLayoutContainer it) {
                FieldLabel _asWidget = ElectricMeasureValueForm.this.theValue.asWidget();
                WidgetExtensions.<FieldLabel>addFill(it, _asWidget);
                FieldLabel _asWidget_1 = ElectricMeasureValueForm.this.measureDate.asWidget();
                WidgetExtensions.<FieldLabel>addFill(it, _asWidget_1);
                FieldLabel _asWidget_2 = ElectricMeasureValueForm.this.measurePerson.asWidget();
