...
import com.fudanmed.platform.core.web.client.device.PMWorkItemManagementPresenterService;
...
@Service("com.fudanmed.platform.core.web.client.device.PMWorkItemManagementPresenterService")
@Transactional
public class PMWorkItemManagementPresenterServiceImpl extends BaseService implements PMWorkItemManagementPresenterService {
  @Autowired
    ...
    IPagedResult<UIPMWorkItem> _xblockexpression = null;
    {
      ...
      final Function1<RCPMWorkItem,UIPMWorkItem> _function = new Function1<RCPMWorkItem,UIPMWorkItem>() {
          public UIPMWorkItem apply(final RCPMWorkItem it) {
            UIPMWorkItem _apply = PMWorkItemManagementPresenterServiceImpl.this.mapper.apply(it);
            return _apply;
          }
        };
      IPagedResult<UIPMWorkItem> _listAndTransform = PagedQueries.<UIPMWorkItem, RCPMWorkItem>listAndTransform(c, new Function<RCPMWorkItem,UIPMWorkItem>() {
          public UIPMWorkItem apply(RCPMWorkItem arg0) {
  ...
  public void finishWorkItem(final RCPMWorkItemProxy value) throws SessionTimeOutException, ValidationException {
