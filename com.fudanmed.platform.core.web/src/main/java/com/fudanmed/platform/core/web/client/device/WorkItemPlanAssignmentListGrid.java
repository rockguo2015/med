...
public class WorkItemPlanAssignmentListGrid extends GXTGridComponent<UIWorkItemPlanAssignment> implements IInitializerSupport {
  ...
  public Iterable<ICanAsWidget> getAllProperties() {
    return com.google.common.collect.Lists.newArrayList(
    					(ICanAsWidget)sid,(ICanAsWidget)name,(ICanAsWidget)specification,(ICanAsWidget)location,(ICanAsWidget)deviceType,(ICanAsWidget)pmType,(ICanAsWidget)planDate,(ICanAsWidget)intervalInDays,(ICanAsWidget)smstatus
    					);
  }
