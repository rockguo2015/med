...
public class NumberProvider<T extends Object, V extends Object> implements ValueProvider<T,V> {
  private Function1<? super T,? extends V> provider;
  
  public NumberProvider(final Function1<? super T,? extends V> provider) {
