...
@RemoteServiceRelativePath("service/com.fudanmed.platform.core.web.client.device.DeleteDeviceDocumentStorageCommandService")
public interface DeleteDeviceDocumentStorageCommandService extends RemoteService {
