...
public class CenterlizedDeliverTaskForm extends GXTFormComponent<UICenterlizedDeliverTask> implements IInitializerSupport {
  @Inject
  ...
  public void initialize(final IPostInitializeAction handler) {
    java.util.Collection<com.uniquesoft.gwt.client.common.async.IInitializerSupport> _initializerSupports = com.google.common.collect.Lists.newArrayList();if(con instanceof com.uniquesoft.gwt.client.common.async.IInitializerSupport){
  ...
  protected CenterlizedDeliverTaskForm doSetValue(final UICenterlizedDeliverTask value) {
    this.value = value;
  ...
  public Widget asWidget() {
    final Function1<Void,VerticalLayoutContainer> _function = new Function1<Void,VerticalLayoutContainer>() {
        public VerticalLayoutContainer apply(final Void it) {
          VerticalLayoutContainer _VLayout = CenterlizedDeliverTaskForm.this.widgets.VLayout();
