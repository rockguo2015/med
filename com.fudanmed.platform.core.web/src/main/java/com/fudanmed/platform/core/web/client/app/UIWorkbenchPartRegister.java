...
public class UIWorkbenchPartRegister {
  ...
  public void initialize() {
    ...
    final WorkbenchCategoryImpl basic = _workbenchCategoryImpl;
    this.workbenchManager.registerPresenterCategory(basic);
    ...
    final WorkbenchCategoryImpl pmCategory = _workbenchCategoryImpl_7;
    this.workbenchManager.registerPresenterCategory(pmCategory);
    ...
    ImageResource _nav5_4 = MedImages.INSTANCE.nav5();
    WorkbenchCategoryImpl _workbenchCategoryImpl_9 = new WorkbenchCategoryImpl("com.fudanmed.platform.core.web.measure", "\u6284\u8868\u7BA1\u7406", _nav5_4);
    final WorkbenchCategoryImpl measureCategory = _workbenchCategoryImpl_9;
    this.workbenchManager.registerPresenterCategory(measureCategory);
    ImageResource _nav3_2 = MedImages.INSTANCE.nav3();
    WorkbenchCategoryImpl _workbenchCategoryImpl_10 = new WorkbenchCategoryImpl("com.fudanmed.platform.core.web.deliver", "\u8FD0\u9001\u7BA1\u7406", _nav3_2);
    final WorkbenchCategoryImpl deliverCategory = _workbenchCategoryImpl_10;
    this.workbenchManager.registerPresenterCategory(deliverCategory);
    ...
    this.workbenchManager.registerDialogProxy(
      ...
      "\u7535\u5B50\u5C4F");
    this.workbenchManager.registerCommand(basic, this.updateEBoardMessageCommand);
    ...
    this.workbenchManager.registerPresenterProxy(
      ...
      "PM\u8C03\u5EA6\u5DE5\u4F5C\u53F0");
    this.workbenchManager.registerCommand(pmCategory, this.showDevicePMPlanCommand);
    ...
    this.workbenchManager.registerCommand(statCategory, this.repairTaskStatByReportSourceCommand);
    this.workbenchManager.registerCommand(measureCategory, this.showMeasureDeviceManagementPresenterCommand);
    ...
    this.workbenchManager.registerCommand(deliverCategory, this.showDeliverPatientCheckTypeManagementCommand);
    this.workbenchManager.registerCommand(deliverCategory, this.showDeliverMaterialCategoryManagementCommand);
  }
}
