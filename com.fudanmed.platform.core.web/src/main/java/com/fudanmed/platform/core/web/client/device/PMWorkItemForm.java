...
public class PMWorkItemForm extends GXTFormComponent<UIPMWorkItem> implements IInitializerSupport {
  ...
  public void initialize(final IPostInitializeAction handler) {
    java.util.Collection<com.uniquesoft.gwt.client.common.async.IInitializerSupport> _initializerSupports = com.google.common.collect.Lists.newArrayList();sid = stringValueProviderFactory.createAsReadonlyItem("sid","任务单号");
  ...
  public Iterable<ICanAsWidget> getAllProperties() {
    return com.google.common.collect.Lists.newArrayList(
    					(ICanAsWidget)sid,(ICanAsWidget)assignDate,(ICanAsWidget)supplier,(ICanAsWidget)team
    					);
  }
              ...
              public void apply(final PlainHTMLTR it) {
                ...
                final Procedure1<PlainHTMLTD> _function = new Procedure1<PlainHTMLTD>() {
                    public void apply(final PlainHTMLTD it) {
                      FieldLabel _asWidget = PMWorkItemForm.this.sid.asWidget();
