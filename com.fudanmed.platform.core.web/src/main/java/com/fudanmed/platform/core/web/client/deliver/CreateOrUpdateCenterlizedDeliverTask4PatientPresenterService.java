...
public interface CreateOrUpdateCenterlizedDeliverTask4PatientPresenterService extends RemoteService {
  ...
  public abstract void createValue(final UICenterlizedDeliverTask4Patient uivalue, final Collection<UIPatientCheckDeliver> patients) throws SessionTimeOutException, ValidationException, DataBaseConstraintException;
