...
public class WaterMeasureValueListGrid extends GXTGridComponent<UIWaterMeasureValue> implements IInitializerSupport {
  ...
  public DateColumn<UIWaterMeasureValue> measureDate;
  ...
  public void initialize(final IPostInitializeAction handler) {
    ...
    measureDate = dateValueProviderFactory.createAsStringColumn("measureDate","抄表日期",UIWaterMeasureValue.MeasureDateAccessor);
