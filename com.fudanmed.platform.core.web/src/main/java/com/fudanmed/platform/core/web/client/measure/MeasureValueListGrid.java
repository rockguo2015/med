...
public class MeasureValueListGrid extends GXTGridComponent<UIMeasureValue> implements IInitializerSupport {
  ...
  public DateColumn<UIMeasureValue> measureDate;
  ...
  public void initialize(final IPostInitializeAction handler) {
    ...
    measureDate = dateValueProviderFactory.createAsStringColumn("measureDate","抄表日期",UIMeasureValue.MeasureDateAccessor);
