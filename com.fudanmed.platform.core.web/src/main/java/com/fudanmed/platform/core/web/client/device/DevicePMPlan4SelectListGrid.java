...
public class DevicePMPlan4SelectListGrid extends GXTGridComponent<UIDevicePMPlan> implements IInitializerSupport {
  @Inject
  ...
  protected DevicePMPlan4SelectListGrid doSetValue(final UIDevicePMPlan value) {
    this.value = value;
