...
import com.fudanmed.platform.core.web.client.device.DeviceListView;
...
public class DevicePMSpecificationForm extends GXTFormComponent<UIDevicePMSpecification> implements IInitializerSupport {
  ...
  public void initialize(final IPostInitializeAction handler) {
    ...
    if(deviceListView instanceof com.uniquesoft.gwt.client.common.async.IInitializerSupport){
    							_initializerSupports.add((com.uniquesoft.gwt.client.common.async.IInitializerSupport)deviceListView);
