...
import com.fudanmed.platform.core.web.client.device.DeivcePMPlanForm;
...
public class CreateOrUpdateDevicePMPlanView extends FormViewerImpl<UIDevicePMPlan> implements CreateOrUpdateDevicePMPlanPresenterView, IHasSize, IHasTitle {
  @Inject
  ...
  @Inject
  private DeivcePMPlanForm form;
  
  public DeivcePMPlanForm doGetFormComponent() {
    return form;
  }
