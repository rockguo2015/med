...
public class UpdateDeviceDocumentStorageCommand extends BaseContextAwareSingleObjectCommand<DocumentStorageProxy> implements IContextConsumer<DocumentStorageProxy> {
  @Inject
  ...
  public String getActionId() {
    return "com.fudanmed.platform.core.web.UpdateDeviceDocumentStorageCommand";
  }
