...
@RemoteServiceRelativePath("service/com.fudanmed.platform.core.web.client.device.DeleteDevicePictureCommandService")
public interface DeleteDevicePictureCommandService extends RemoteService {
