...
public class WorkItemFinishOutsourceDataForm extends GXTFormComponent<WorkItemFinishOutsourceData> implements IInitializerSupport {
  @Inject
  ...
  public WorkItemFinishOutsourceData getValueAsNew() {
    WorkItemFinishOutsourceData value = new WorkItemFinishOutsourceData();
  ...
  public WorkItemFinishOutsourceData doGetValue() {
  ...
  public WorkItemFinishOutsourceData getValue(final WorkItemFinishOutsourceData copyValue) {
  ...
  protected WorkItemFinishOutsourceDataForm doSetValue(final WorkItemFinishOutsourceData value) {
    this.value = value;
  ...
  public Widget asWidget() {
    final Function1<Void,VerticalLayoutContainer> _function = new Function1<Void,VerticalLayoutContainer>() {
        public VerticalLayoutContainer apply(final Void it) {
          VerticalLayoutContainer _VLayout = WorkItemFinishOutsourceDataForm.this.widgets.VLayout();
          final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
              public void apply(final VerticalLayoutContainer it) {
                FieldLabel _asWidget = WorkItemFinishOutsourceDataForm.this.finishDate.asWidget();
                int _minus = (-1);
                VerticalLayoutData _VLayoutData = WorkItemFinishOutsourceDataForm.this.widgets.VLayoutData(1, _minus);
                it.add(_asWidget, _VLayoutData);
                FieldLabel _asWidget_1 = WorkItemFinishOutsourceDataForm.this.finishTime.asWidget();
                int _minus_1 = (-1);
                VerticalLayoutData _VLayoutData_1 = WorkItemFinishOutsourceDataForm.this.widgets.VLayoutData(1, _minus_1);
                it.add(_asWidget_1, _VLayoutData_1);
                FieldLabel _asWidget_2 = WorkItemFinishOutsourceDataForm.this.deviceSid.asWidget();
                int _minus_2 = (-1);
                VerticalLayoutData _VLayoutData_2 = WorkItemFinishOutsourceDataForm.this.widgets.VLayoutData(1, _minus_2);
                it.add(_asWidget_2, _VLayoutData_2);
                FieldLabel _asWidget_3 = WorkItemFinishOutsourceDataForm.this.price.asWidget();
                int _minus_3 = (-1);
                VerticalLayoutData _VLayoutData_3 = WorkItemFinishOutsourceDataForm.this.widgets.VLayoutData(1, _minus_3);
                it.add(_asWidget_3, _VLayoutData_3);
                FieldLabel _asWidget_4 = WorkItemFinishOutsourceDataForm.this.comment.asWidget();
                VerticalLayoutData _VLayoutData_4 = WorkItemFinishOutsourceDataForm.this.widgets.VLayoutData(366, 80);
                it.add(_asWidget_4, _VLayoutData_4);
                FieldLabel _asWidget_5 = WorkItemFinishOutsourceDataForm.this.alsoReport.asWidget();
                int _minus_4 = (-1);
                VerticalLayoutData _VLayoutData_5 = WorkItemFinishOutsourceDataForm.this.widgets.VLayoutData(120, _minus_4);
                it.add(_asWidget_5, _VLayoutData_5);
                FieldLabel _asWidget_6 = WorkItemFinishOutsourceDataForm.this.reportComment.asWidget();
                VerticalLayoutData _VLayoutData_6 = WorkItemFinishOutsourceDataForm.this.widgets.VLayoutData(366, 80);
