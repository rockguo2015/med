...
public class PhasedElectricMeasureValueListGrid extends GXTGridComponent<UIPhasedElectricMeasureValue> implements IInitializerSupport {
  ...
  public DateColumn<UIPhasedElectricMeasureValue> measureDate;
  ...
  public void initialize(final IPostInitializeAction handler) {
    ...
    measureDate = dateValueProviderFactory.createAsStringColumn("measureDate","抄表日期",UIPhasedElectricMeasureValue.MeasureDateAccessor);
