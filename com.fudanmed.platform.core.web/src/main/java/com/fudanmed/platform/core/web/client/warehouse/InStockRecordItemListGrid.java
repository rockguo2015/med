...
public class InStockRecordItemListGrid extends GXTGridComponent<UIInStockRecordItem> implements IInitializerSupport {
  @Inject
  ...
  public void initialize(final IPostInitializeAction handler) {
    ...
    productSpecName = stringValueProviderFactory.createAsStringColumn("productSpecName","物品名称",UIInStockRecordItem.ProductSpecNameAccessor);
    widgetsRegistory.put("productSpecName",productSpecName);
    typeDesc = stringValueProviderFactory.createAsStringColumn("typeDesc","规格型号",UIInStockRecordItem.TypeDescAccessor);
    ...
    price = doubleValueProviderFactory.createAsEditableDoubleColumn("price","单价",UIInStockRecordItem.PriceAccessor);
    widgetsRegistory.put("price",price);
    quantity = integerValueProviderFactory.createAsEditableIntegerColumn("quantity","数量",UIInStockRecordItem.QuantityAccessor);
  ...
  protected InStockRecordItemListGrid doSetValue(final UIInStockRecordItem value) {
    this.value = value;
