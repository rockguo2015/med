      ...
      final Procedure1<JSONObject> _function = new Procedure1<JSONObject>() {
          public void apply(final JSONObject it) {
            try {
              ...
              Date _time = workitem.getTime();
              String _dateTimeString_1 = JSONUtil.toDateTimeString(_time);
              JSONObject _put_5 = _put_4.put("time", _dateTimeString_1);
              ...
              JSONObject _put_6 = _put_5.put("workers", _join);
              RCGroupTask _groupTask_2 = workitem.getGroupTask();
              RCRepairTask _repairTask_2 = _groupTask_2.getRepairTask();
              String _comment = _repairTask_2.getComment();
              JSONObject _put_7 = _put_6.put("comment", _comment);
              ...
              JSONObject _put_8 = _put_7.put("location", _location);
              ...
              String _entityName = _reportOrg.getEntityName();
              JSONObject _put_9 = _put_8.put("organization", _entityName);
              ...
              JSONObject _put_10 = _put_9.put("reporter", _reporterName);
              ...
              _put_10.put("reporterPhone", _reporterPhone);
            } catch (Exception _e) {
              throw Exceptions.sneakyThrow(_e);
            }
          }
