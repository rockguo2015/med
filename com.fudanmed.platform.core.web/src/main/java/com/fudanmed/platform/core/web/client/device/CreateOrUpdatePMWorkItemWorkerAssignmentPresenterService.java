...
public interface CreateOrUpdatePMWorkItemWorkerAssignmentPresenterService extends RemoteService {
  ...
  public abstract void createValue(final Collection<UIWorkItemPlanAssignment> planAssignments, final RCPMWorkItemProxy parent, final UIPMWorkItemWorkerAssignment uivalue) throws SessionTimeOutException, ValidationException, DataBaseConstraintException;
