...
public class PMWorkItemWorkerAssignmentPendForm extends GXTFormComponent<UIPMWorkItemWorkerAssignment> implements IInitializerSupport {
  ...
  public void initialize(final IPostInitializeAction handler) {
    java.util.Collection<com.uniquesoft.gwt.client.common.async.IInitializerSupport> _initializerSupports = com.google.common.collect.Lists.newArrayList();finalComment = stringValueProviderFactory.createAsTextAreaItem("finalComment","情况说明");
