...
public interface CreateOrUpdatePMWorkItemWorkerAssignmentPresenterServiceAsync {
  ...
  public abstract void createValue(final Collection<UIWorkItemPlanAssignment> planAssignments, final RCPMWorkItemProxy parent, final UIPMWorkItemWorkerAssignment uivalue, final AsyncCallback<Void> callback);
