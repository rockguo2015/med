...
import edu.fudan.langlab.gxt.client.component.grid.factory.ActionColumnValueProviderFactory.TextButtonActionColumn;
...
public class DocumentStorageListGrid extends GXTGridComponent<UIDocumentStorage> implements IInitializerSupport {
  @Inject
  ...
  public void initialize(final IPostInitializeAction handler) {
    ...
    download = actionColumnValueProviderFactory.createAsButtonColumn("download","查看",UIDocumentStorage.DownloadAccessor);
    widgetsRegistory.put("download",download);
  ...
  public UIDocumentStorage getValueAsNew() {
    ...
    value.setDownload(download.getValue());
    return value;
  }
  ...
  public UIDocumentStorage getValue(final UIDocumentStorage copyValue) {
    ...
    copyValue.setDownload(download.getValue());
    return copyValue;
  }
  
  protected DocumentStorageListGrid doSetValue(final UIDocumentStorage value) {
    this.value = value;
    name.setValue(value.getName());
    uploadTime.setValue(value.getUploadTime());
    download.setValue(value.getDownload());
    valueUpdated(value);return this;
  }
  
  public Iterable<ICanAsWidget> getAllProperties() {
    return com.google.common.collect.Lists.newArrayList(
    					(ICanAsWidget)name,(ICanAsWidget)uploadTime,(ICanAsWidget)download
    					);
  }
}
