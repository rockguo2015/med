...
public class GasMeasureValueListGrid extends GXTGridComponent<UIGasMeasureValue> implements IInitializerSupport {
  ...
  public DateColumn<UIGasMeasureValue> measureDate;
  ...
  public void initialize(final IPostInitializeAction handler) {
    ...
    measureDate = dateValueProviderFactory.createAsStringColumn("measureDate","抄表日期",UIGasMeasureValue.MeasureDateAccessor);
