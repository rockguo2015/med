...
public class WaterMeasureValueForm extends GXTFormComponent<UIWaterMeasureValue> implements IInitializerSupport {
  @Inject
  ...
  protected WaterMeasureValueForm doSetValue(final UIWaterMeasureValue value) {
    this.value = value;
  ...
  public Widget asWidget() {
    final Function1<Void,VerticalLayoutContainer> _function = new Function1<Void,VerticalLayoutContainer>() {
        public VerticalLayoutContainer apply(final Void it) {
          VerticalLayoutContainer _VLayout = WaterMeasureValueForm.this.widgets.VLayout();
          final Procedure1<VerticalLayoutContainer> _function = new Procedure1<VerticalLayoutContainer>() {
              public void apply(final VerticalLayoutContainer it) {
                FieldLabel _asWidget = WaterMeasureValueForm.this.theValue.asWidget();
                WidgetExtensions.<FieldLabel>addFill(it, _asWidget);
                FieldLabel _asWidget_1 = WaterMeasureValueForm.this.measureDate.asWidget();
                WidgetExtensions.<FieldLabel>addFill(it, _asWidget_1);
                FieldLabel _asWidget_2 = WaterMeasureValueForm.this.measurePerson.asWidget();
