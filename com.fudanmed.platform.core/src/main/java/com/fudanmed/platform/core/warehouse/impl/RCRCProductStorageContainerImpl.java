      ...
      final Function1<RCProductStorage,RCRecordItem> _function = new Function1<RCProductStorage,RCRecordItem>() {
          public RCRecordItem apply(final RCProductStorage storage) {
            RCRecordItem _xblockexpression = null;
            {
              ...
              boolean _notEquals = ((quantity).intValue() != 0);
              if (_notEquals) {
                RCProductEntry _productEntry = storage.getProductEntry();
                String _sid = _productEntry.getSid();
                String _plus = ("take from " + _sid);
                String _plus_1 = (_plus + " ");
                String _plus_2 = (_plus_1 + Integer.valueOf(quantityToTake));
              ...
              RCRecordItem _doubleArrow = ObjectExtensions.<RCRecordItem>operator_doubleArrow(_rCRecordItem, _function_2);
