...
public interface DLCenterlizedDeliverTask extends DLTask {
  ...
  public abstract DLCenterlizedDeliverTask setFromLocation(final RCOnsitePosition fromLocation);
  
  public abstract RCOnsitePosition getToLocation();
  
  public abstract DLCenterlizedDeliverTask setToLocation(final RCOnsitePosition toLocation);
