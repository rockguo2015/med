...
public class RCPMWorkItemImpl extends BaseModelObject implements RCPMWorkItem {
  ...
  public void workersAssigned() {
    if(SMState==RCPMWorkItemSMState.teamAssigned||SMState==RCPMWorkItemSMState.executing){
    	_workersAssigned();
  ...
  public void teamFinish(final Date finishDate, final String comment) {
    if(SMState==RCPMWorkItemSMState.executing){
  ...
  public void assignWorker(final Procedure1<? super RCPMWorkItemWorkerAssignment> postInit) {
